<%@ Page Title="" Language="C#" MasterPageFile="~/AppPages/MasterPages/Popup.Master"
    AutoEventWireup="true" CodeBehind="MissionValueEdit.aspx.cs" Inherits="MyPlanner.AppPages.MissionValueEdit" %>
    ...
    <div class="popupContainer" style="width: 400px">
        <table class="popuptableClass">
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtTitle" Width="250px" TabIndex="1"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="popuptableClass td label">
